...
export default function PokemonSilhouette() {
  ...
  return (
    <>
      <div className='intro'>
        <div>
          <span>Player 1:</span><input placeholder='Insert Name of Player 1'></input>
        </div>
        <div>
          <span>Player 2:</span><input placeholder='Insert Name of Player 2'></input>
        </div>
      </div>
      <div className="board-container">
        <Board pokemonUrl={"/images/"+player1[currentPlayer1Round]+".png"} roundNumber={currentPlayer1Round} />
        <Board pokemonUrl={"/images/"+player2[currentPlayer2Round]+".png"} roundNumber={currentPlayer2Round} />
